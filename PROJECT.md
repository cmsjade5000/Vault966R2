...
- Source repository: this Git checkout
...
Use `git status --short` before every new task and keep unrelated edits separate.
Public examples should use synthetic data under `data/samples/`; private runtime
data and generated local reports should stay out of source control.
