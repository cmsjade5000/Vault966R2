...
) -> UpdatePreviewApiCollectionHealthUpdatePreviewGetResponseUpdatePreviewApiCollectionHealthUpdatePreviewGet | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[UpdatePreviewApiCollectionHealthUpdatePreviewGetResponseUpdatePreviewApiCollectionHealthUpdatePreviewGet]:
    return Response(
