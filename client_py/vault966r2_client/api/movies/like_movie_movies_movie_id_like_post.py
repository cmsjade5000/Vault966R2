...
) -> ErrorResponse | LikeMovieMoviesMovieIdLikePostResponseLikeMovieMoviesMovieIdLikePost | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | LikeMovieMoviesMovieIdLikePostResponseLikeMovieMoviesMovieIdLikePost]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | LikeMovieMoviesMovieIdLikePostResponseLikeMovieMoviesMovieIdLikePost
    """
