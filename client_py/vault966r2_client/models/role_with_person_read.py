...
T = TypeVar("T", bound="RoleWithPersonRead")


@_attrs_define
class RoleWithPersonRead:
    """
    Attributes:
        id (int):
        movie_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person = PersonNested.from_dict(d.pop("person"))
        ...
        role_with_person_read.additional_properties = d
        return role_with_person_read
