...
class BodyUploadFirstImportSnapshotUiFirstImportUploadPost:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_upload_first_import_snapshot_ui_first_import_upload_post.additional_properties = d
        return body_upload_first_import_snapshot_ui_first_import_upload_post
